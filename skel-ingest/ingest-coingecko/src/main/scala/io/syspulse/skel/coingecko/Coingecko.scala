...
// JSON formats for the new case classes
  ...
  implicit val js_cg_CoinData: RootJsonFormat[Coingecko_CoinData] = new RootJsonFormat[Coingecko_CoinData] {
    def write(obj: Coingecko_CoinData): JsValue = JsObject(
      ...
      "localization" -> obj.localization.toJson,
      ...
      "market_cap_rank" -> JsNumber(obj.market_cap_rank),
      "market_data" -> obj.market_data.toJson,
      "community_data" -> obj.community_data.toJson,
      "developer_data" -> obj.developer_data.toJson,
    ...
    def read(json: JsValue): Coingecko_CoinData = {
      ...
      Coingecko_CoinData(
        ...
        localization = obj("localization").convertTo[Coingecko_Localization],
        description = obj("description").convertTo[Coingecko_Description],
        links = obj("links").convertTo[Coingecko_Links],
        image = obj("image").convertTo[Coingecko_Image],
        ...
        market_cap_rank = obj("market_cap_rank").convertTo[Int],
        market_data = obj("market_data").convertTo[Coingecko_MarketData],
        community_data = obj("community_data").convertTo[Coingecko_CommunityData],
        developer_data = obj("developer_data").convertTo[Coingecko_DeveloperData],
