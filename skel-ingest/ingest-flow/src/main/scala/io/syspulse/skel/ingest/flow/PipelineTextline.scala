...
class PipelineTextline(feed:String,output:String,throttle:Long = 0)(implicit config:Config) extends 
      Pipeline[String,String,Textline](feed,output,throttle,config.delimiter,config.buffer) {
