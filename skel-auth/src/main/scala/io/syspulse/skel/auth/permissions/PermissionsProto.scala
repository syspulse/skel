...
final case class Permissionss(permissions: immutable.Seq[Permissions])
final case class PermissionsCreateReq(uid:UUID, permissions:Seq[String])
...
final case class PermissionsUpdateReq(uid:UUID, permissions:Option[Seq[String]])