...
final case class Auth(accessToken:String, uid: Option[UUID], idToken:String, scope:Option[String], expire: Long)
...
final case class AuthWithProfileRes(accesToken:String, uid: Option[UUID], idToken:String, eid:String, email:String, name:String, avatar:String, locale:String)
...
object Auth {
  ...
  def apply(accessToken:String, uid: Option[UUID], idToken:String, scope:Option[String], age: Long = DEF_AGE):Auth = {
