...
//   }
  ...
  "SolidityTuple tuples[] arrays" should {
    ...
    "decode (uint256,address)[],(int256,int8) " in {
      ...
      val r1 = SolidityTuple.decode("0x" + hex, List("(uint256,address)[]","(int256,int8)"))
      r1 should === ("[((10,0x742d35cc6634c0532925a3b844bc454e4438f44e)),((20,0x742d35cc6634c0532925a3b844bc454e4438f44e))],(10000,7)")

      val r2 = SolidityTuple.decodeTupleResult("0x" + hex, "(uint256,address)[],(int256,int8)")
      r2 should === ("[((10,0x742d35cc6634c0532925a3b844bc454e4438f44e)),((20,0x742d35cc6634c0532925a3b844bc454e4438f44e))],(10000,7)")
    }
