...
case class Config(
  dataSource:(String,String,String) = ("","telemetry.data-source","influx"),
  ...
  logFile:(String,String,String) = ("","telemetry.log-file",""),
  grafiteUri:(String,String,String) = ("","telemetry.grafite-uri","localhost:2003"),
  influxUri:(String,String,String) = ("","telemetry.influx-uri","http://localhost:8086"),
  influxUser:(String,String,String) = ("","telemetry.influx-user","ekm_user"),
  influxPass:(String,String,String) = ("","telemetry.influx-pass","ekm_pass"),
...
object App extends SkelApp {
  ...
  def main(args:Array[String]): Unit = {
    ...
    val argsParser = {
      import builder._
      OParser.sequence(
        programName("skel-telemetry"), head("skel-telemetry", "0.0.1"),
        ...
        cmd("influx").action( (_, c) => c.copy(dataSource = ("influx",c.grafiteUri._2,c.grafiteUri._3)) ).text("Influx DataSource.").children(),
        cmd("grafite").action( (_, c) => c.copy(dataSource = ("grafite",c.grafiteUri._2,c.grafiteUri._3)) ).text("Grafite DataSource.").children()
      )
    } 
