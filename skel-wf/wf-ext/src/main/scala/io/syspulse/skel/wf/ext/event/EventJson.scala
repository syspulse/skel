...
object EventJson extends JsonCommon {
  implicit val jf_alert: RootJsonFormat[Alert] = jsonFormat19(Alert.apply)
  implicit val jf_create: RootJsonFormat[EventCreateReq] = jsonFormat17(EventCreateReq.apply)
