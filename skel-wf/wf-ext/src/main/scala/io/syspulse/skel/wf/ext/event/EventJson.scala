...
object EventJson extends JsonCommon {
  implicit val jf_alert: RootJsonFormat[Alert] = jsonFormat17(Alert.apply)
  implicit val jf_create: RootJsonFormat[EventCreateReq] = jsonFormat15(EventCreateReq.apply)
