...
- Command to link WorkflowConfig created from DSL to Temporal via `xid`.
  ...
  ```
  ./run-wf.sh --wf=temporal:// assembly-link 019e7473-05d1-789f-bb4b-44845bd69fc6  '[PoO] -> [PoR] -> [Report]'
  ``` 

- Command to get all Runtime workflows.
  Example:
  ```
  ./run-wf.sh --wf=temporal:// runtime-get'
  ``` 

- Command to get Runtime workflow.
  Example:
  ```
  ./run-wf.sh --wf=temporal:// runtime-get 019e7473-062b-7e26-8925-e202fe0285a1'
  ``` 
